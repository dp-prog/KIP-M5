...
#define SS_SELECT()		HAL_GPIO_WritePin(CS_PORT, CS_PIN, GPIO_PIN_RESET)
#define SS_DESELECT()	HAL_GPIO_WritePin(CS_PORT, CS_PIN, GPIO_PIN_SET)
#define LD_ON			HAL_GPIO_WritePin(LD3_GPIO_Port, LD3_Pin, GPIO_PIN_RESET);
#define LD_OFF			HAL_GPIO_WritePin(LD3_GPIO_Port, LD3_Pin, GPIO_PIN_SET);
*/
/* Äëÿ ÊÈÏ-Ì */
#define CS_PORT			Eth_CS_GPIO_Port
#define CS_PIN			Eth_CS_Pin
#define SS_SELECT()		HAL_GPIO_WritePin(CS_PORT, CS_PIN, GPIO_PIN_RESET)
#define SS_DESELECT()	HAL_GPIO_WritePin(CS_PORT, CS_PIN, GPIO_PIN_SET)
//#define LD_ON			HAL_GPIO_WritePin(Led3_GPIO_Port, Led3_Pin, GPIO_PIN_RESET);
//#define LD_OFF			HAL_GPIO_WritePin(Led3_GPIO_Port, Led3_Pin, GPIO_PIN_SET);
#define LD_ON
#define LD_OFF
//--------------------------------------------------
#define ENC28J60_MAXFRAME		1500
#define MAC_ADDR		{0xD7,0x12,0x34,0x56,0x78,0x90}
//--------------------------------------------------
